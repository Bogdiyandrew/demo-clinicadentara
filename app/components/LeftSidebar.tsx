...
export default function LeftSidebar() {
  ...
  return (
    ...
    <aside className="hidden md:flex md:w-64 md:flex-col fixed inset-y-0 z-50">
      <div className="flex flex-col grow bg-white/80 backdrop-blur-xl border-r border-white/20 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">

        <div className="flex items-center justify-center h-24 border-b border-slate-100/50">
          <Link href="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 rounded-xl bg-linear-to-br from-primary to-secondary p-0.5 shadow-lg shadow-primary/20 group-hover:shadow-primary/30 transition-all duration-300">
              ...
              return (
                ...
                >
                  {isActive && (
                    <motion.div
                      layoutId="activeTab"
                      className="absolute inset-0 bg-linear-to-r from-primary to-cyan-600"
                      initial={false}
                  ...
                  <item.icon
                    className={`
                      mr-3 h-5 w-5 shrink-0 transition-colors duration-300 relative z-10
        ...
        <div className="p-4 border-t border-slate-100/50 bg-slate-50/50">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-linear-to-br from-slate-200 to-slate-300 flex items-center justify-center text-slate-500 font-bold text-sm">
              CD
            </div>
            <div className="flex flex-col">
