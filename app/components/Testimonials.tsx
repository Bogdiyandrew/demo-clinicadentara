...
// Datele pentru testimoniale (ar veni dintr-un CMS)
// Am adăugat 'initials' pentru avatar
const testimonials = [
  {
    name: "Maria Ionescu",
...
export default function Testimonials() {
  return (
    // Secțiune cu fundal închis pentru contrast puternic
    <section className="bg-gray-900 py-20 sm:py-28">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        {/* 'lg:grid-cols-3' = 3 coloane pe desktop, 'md:grid-cols-2' = 2 pe tabletă, 1 pe mobil */}
        <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          {testimonials.map((testimonial) => (
            // Cardul de testimonial
            <div key={testimonial.name} className="flex flex-col bg-gray-800 rounded-2xl shadow-lg p-8">
              
              {/* Pictograma Ghilimele (SVG inline) */}
              <div>
              ...
              {/* Citatul - 'flex-grow' face ca toate cardurile să aibă aceeași înălțime */}
              ...
              <footer className="mt-8 flex items-center gap-4">
                {/* Avatar cu Inițiale (în loc de poză) */}
